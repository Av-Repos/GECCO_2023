...
//Escapes from a local optimum using the objective functions of the decomposition (f^1,f^2,f^3).
...
void VFS(strct_optimo* optimo, int tabu_size, int max_evals){
	...
	printf("%s,VFS,%d,0,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,", Instance, Repetition, actual.opt_fitness, f1, f2, f3, values[0][0], values[0][1], values[0][2], values[1][0], values[1][1], values[1][2], values[2][0], values[2][1], values[2][2]);
	...
	while(evals < max_evals){
		...
		while(cont && evals < max_evals){
			...
			if(!cont){
				...
				printf("%s,VFS,%d,%d,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,%Lf,", Instance, Repetition, iteration, actual.opt_fitness, f1, f2, f3, values[0][0], values[0][1], values[0][2], values[1][0], values[1][1], values[1][2], values[2][0], values[2][1], values[2][2]);
				for(int i = 0; i < PermuSize; i++) printf(" %d", actual.opt_permu[i]);
				printf("\n");
				iteration++;
			}
		}
		//Escape from the local optimum using f^1, f^2, f^3.
		if(evals < max_evals){
